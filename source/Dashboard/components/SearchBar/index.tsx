...
const SearchBar: React.FC = () => {
	...
	const sourceDropdownRef = useRef() as React.MutableRefObject<HTMLInputElement>
	const searchDropdownRef = useRef() as React.MutableRefObject<HTMLInputElement>
	useEffect(() => {
					...
					{googleSearchData.map((query, index) => {
						return (
							<p
								key={query}
								className={
									focusedIndex === index ? styles.focusedQuery : styles.searchQuery
								}
